        ...
        <div className="write-review-container">
            <div className='container-small'>
                ...
                <div className="write-review-form-group">
                    <QuestionGroup label="Was there an accessible restroom available?" field="accessibleRestroom" required>
                    ...
                    <QuestionGroup label="Was the doorway to the restroom wide enough (minimum 85 cm or 33.5 inches)?" field="doorWidthOK" required>
                    ...
                    <QuestionGroup label="Was there enough space to maneuver a wheelchair inside the restroom?" field="spaceToManeuver" required>
                    ...
                    <QuestionGroup label="Were grab bars installed near the toilet and sink?" field="grabBarsInstalled" required>
                    ...
                    <QuestionGroup label="Was the sink accessible (e.g., appropriate height, space underneath)?" field="sinkAccessible" required>
                    ...
                    <QuestionGroup label="Was there an accessible shower facility (if applicable)?" field="showerAvailable" required>
