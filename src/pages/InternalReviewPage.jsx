    ...
    return (
        <div className="write-review-container">
            ...
            <div className="write-review-form-group">
                ...
                <QuestionGroup label="Were there elevators or ramps to navigate between floors?" field="elevatorOrRamp">
                ...
                <QuestionGroup label="If elevators, were they spacious and accessible?" field="elevatorAccessible">
                ...
                <QuestionGroup label="Did you encounter any obstacles inside (e.g., narrow passages, furniture blocking the way)?" field="obstaclesLevel">
